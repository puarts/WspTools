...
namespace wsp{
    namespace opencv{
        ...
        {
        public:
            cvSaliencyMap(int height, int width, const wsp::opencv::SaliencyMapParam &param);

            /**
             * @brief Core function for saliency map generation.
             */
            CvMat* GetSaliencyMap(IplImage *src, wsp::opencv::SaliencyMapParam &param);
        ...
        private:
            ...
            wsp::opencv::SaliencyMapParam saliency_map_param_;
